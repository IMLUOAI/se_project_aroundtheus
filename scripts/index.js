...
const profileModalForm = editProfileModal.querySelector("#profile-form");
...
const profileNameInput = profileModalForm.querySelector("#profile-name-input");
const profileJobInput = profileModalForm.querySelector(
